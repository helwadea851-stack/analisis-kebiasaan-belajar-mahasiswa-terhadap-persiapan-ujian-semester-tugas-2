# analisis-kebiasaan-mahasiswa-tugas-2 
## Latar Belakang
...
Berdasarkan hal tersebut, penelitian ini dilakukan untuk menganalisis kebiasaan belajar mahasiswa terhadap persiapan ujian semester menggunakan data kuesioner. Analisis dilakukan melalui uji validitas dan uji reliabilitas untuk memastikan bahwa instrumen penelitian yang digunakan mampu mengukur variabel secara tepat dan konsisten.
...
## Metode
Penelitian ini menggunakan metode kuantitatif dengan teknik pengumpulan data melalui penyebaran kuesioner kepada mahasiswa Program Studi Statistika universitas mataram sebagai populasi penelitian. Data yang diperoleh kemudian dianalisis menggunakan bahasa pemrograman R. Tahapan analisis meliputi penentuan jumlah sampel menggunakan rumus Slovin, uji validitas menggunakan korelasi item-total, serta uji reliabilitas menggunakan metode Cronbach Alpha. Pengolahan data dilakukan dengan bantuan package `readxl` untuk membaca data dan `psych` untuk analisis statistik.
